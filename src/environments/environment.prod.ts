...
export const environment = {
  ...
  APIEndpointForum: "https://forum-stg.ourbetterworld.org",
  APIEndpointForumLocal: "http://192.168.10.31:4567",
  APIEndpointIpAddress: "https://api.ipify.org?format=json",
  SiteKey: "6LduEn4UAAAAAPNxsho275U8IyW44Iw1DDv2GLAD", // Domains: localhost
  ...
  OAuth2: {
    ...
    RefreshTokenGrantType: "refresh_token",
    configClient: {
      client_id: "2133ce79-8b53-44b2-ba5e-34ba76326c1c",
